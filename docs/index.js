...
var _balance = __webpack_require__(332);

var _balance2 = _interopRequireDefault(_balance);

var _nxtLesson = __webpack_require__(333);
...
var sliderToggles = document.querySelector('.nxt-lesson__slider-block');
(0, _slider2.default)(sliderToggles);

var balanceTabs = document.querySelectorAll('.balance__tab-block');
var balanceCharts = document.querySelectorAll('.balance__chart');
for (var _i = 0; _i < balanceTabs.length; _i++) {
    (0, _balance2.default)(balanceTabs[_i], balanceCharts[_i]);
}
...
exports.default = balanceTabsToggle;
function balanceTabsToggle(balanceTabs, balanceCharts) {
    var tabs = balanceTabs.querySelectorAll('.balance__tab');
    var charts = balanceCharts.querySelectorAll('.chart__info');

    var activeTab = balanceTabs.querySelector('.balance__tab_selected');
    var activeChart = balanceCharts.querySelector('.chart__info_shown');

    for (var i = 0; i < tabs.length; i++) {
        tabs[i].setAttribute('data-id', i);
    }

    balanceTabs.addEventListener('click', function () {
        if (activeTab) {
...
function slider(targetToggles) {
    var toggles = targetToggles.querySelectorAll('.toggle');
    var circles = targetToggles.querySelectorAll('.circle');

    var activeToggle = targetToggles.querySelector('.toggle_active');
    var activeCircle = targetToggles.querySelector('.circle_active');
    ...
    for (var _i = 0; _i < circles.length; _i++) {
        circles[_i].setAttribute('data-id-circle', _i);
    }

    function toggleSlider(event) {
        event.preventDefault();
        var toggleId = event.target.getAttribute('data-id-toggle');
        var circleId = +activeCircle.getAttribute('data-id-circle');
